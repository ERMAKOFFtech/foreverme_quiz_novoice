const flow = [
  {
    ...
    note: 'By continuing, you confirm you have read and agreed to our Terms of Use, Privacy Policy, and Refund Policy.',
    options: [
  ...
  },
  {
    ...
    image: 'assets/img/spec_pause_1.jpg',
  ...
  },
  {
    type: 'interstitial',
    title: 'Thank you',
    image: 'assets/img/spec_pause_2.jpg',
    heading: 'Thank you!',
  ...
  },
  {
    ...
    title: 'Support note',
    sliderImages: [
      'assets/img/spec_pause_3_1.jpg',
      'assets/img/spec_pause_3_2.jpg',
      'assets/img/spec_pause_3_3.jpg'
    ],
  ...
  },
  {
    ...
    logoImages: [
      'assets/img/magazine_logo_1.jpeg',
      'assets/img/magazine_logo_2.jpeg',
      'assets/img/magazine_logo_3.jpeg',
      'assets/img/magazine_logo_4.jpeg',
      'assets/img/magazine_logo_5.jpeg',
      'assets/img/magazine_logo_6.jpeg'
    ],
    logosStyle: 'floating',
    buttonText: 'Continue'
  },
  ...
  },
  {
    ...
    logoImages: [
      'assets/img/univer_1.png',
      'assets/img/univer_2.png',
      'assets/img/univer_3.png'
    ],
    logosStyle: 'stack',
    buttonText: 'Continue'
  },
...
function renderAgeGate(item) {
  const ageImages = {
    '25_49': 'assets/img/age-25-49.jpg',
    '50_59': 'assets/img/age-50-59.jpg',
    '60_69': 'assets/img/age-60-69.jpg',
    '70_plus': 'assets/img/age-70+.jpg'
  };
...
function renderInterstitial(item) {
  ...
  if (item.layout === 'collage') {
    const collageImages = [
      'assets/img/screen3_img1.jpg',
      'assets/img/screen3_img2.jpg',
      'assets/img/screen3_img3.jpg',
      'assets/img/screen3_img4.jpg',
      'assets/img/screen3_img5.jpg',
      'assets/img/screen3_img6.jpg',
      'assets/img/screen3_img7.jpg',
      'assets/img/screen3_img8.jpg'
    ];
    ...
    host.innerHTML = `
      <section class="screen-card interstitial-card interstitial-collage-card fade-in">
        ...
        <div class="collage-wrap" aria-hidden="true">
          ...
          <img class="collage-center" src="assets/img/screen3_centreimg.jpg" alt="Happy user">
  ...
  if (item.heading || item.body?.length) {
    host.innerHTML = `
      <section class="screen-card interstitial-card fade-in">
        <img class="interstitial-top-image" src="${item.image || 'assets/img/age-50-59.jpg'}" alt="Pause and reflect illustration">
        ${item.heading ? `<h3 class="interstitial-heading">${item.heading}</h3>` : ''}
...
function renderEmail() {
  ...
  const validate = () => {
    ...
    continueBtn.disabled = !/^\S+@\S+\.\S+$/.test(state.email);
  };
  ...
  host.innerHTML = `
    <section class="screen-card paywall-card fade-in">
        ...
        <div class="comparison-grid">
          <div class="comparison-col comparison-col-before">
            ...
            <div class="comparison-visual">
              <img src="assets/img/before_quiz_final.jpg" alt="Before ForeverMe experience" class="comparison-image">
            </div>
          ...
          <div class="comparison-col comparison-col-highlight">
            ...
            <div class="comparison-visual">
              <img src="assets/img/after_quiz_final.jpg" alt="With ForeverMe experience" class="comparison-image">
            </div>
            <ul class="comparison-list">
      ...
      <div class="paywall-block">
        <details class="demo-accordion">
          ...
          <div class="demo-video-wrap">
            <video
              class="demo-video"
              src="https://foreverme.love/assets/video/fme_liveapp_video_cycle.mp4"
              autoplay
              muted
              loop
              playsinline
      ...
      <div class="paywall-cta-zone">
        <button class="btn btn-dark btn-main paywall-cta-btn" type="button" id="activateTrialBtn">Activate Free Trial</button>
      </div>
    </section>
  `;

  document.getElementById('activateTrialBtn').addEventListener('click', openLemonSqueezyCheckout);
  setSticky({ show: false });
}

function openLemonSqueezyCheckout() {
  const checkoutUrl = 'https://foreverme.lemonsqueezy.com/checkout/buy/91aac0c2-18fc-4c25-9a85-c44ab62c3aa6?embed=1&enabled=1111695';
  ...
  if (!window.createLemonSqueezy) {
    const modal = new bootstrap.Modal(document.getElementById('fallbackCheckoutModal'));
    modal.show();
  }
}
