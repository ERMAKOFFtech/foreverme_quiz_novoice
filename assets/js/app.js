const flow = [
    ...
    },
    {
        type: 'interstitial',
        title: 'Thank you',
        image: '/assets/quiz/start-super-trial/img/spec_pause_2.jpg',
        heading: 'Thank you!',
    ...
    },
    {
        ...
        title: 'Support note',
        sliderImages: [
            '/assets/quiz/start-super-trial/img/spec_pause_3_1.jpg',
            '/assets/quiz/start-super-trial/img/spec_pause_3_2.jpg',
            '/assets/quiz/start-super-trial/img/spec_pause_3_3.jpg'
        ],
    ...
    },
    {
        ...
        image: '/assets/quiz/start-super-trial/img/pause_1.jpg',
    ...
    },
    {
        ...
        image: '/assets/quiz/start-super-trial/img/pause_2.jpg',
    ...
    },
    {
        ...
        image: '/assets/quiz/start-super-trial/img/pause_3.jpg',
    ...
    },
    {
        ...
        image: '/assets/quiz/start-super-trial/img/pause_4.jpg',
    ...
    },
    {
        ...
        image: '/assets/quiz/start-super-trial/img/pause_5.jpg',
    ...
    },
    {
        ...
        image: '/assets/quiz/start-super-trial/img/pause_6.jpg',
    ...
    },
    {
        ...
        image: '/assets/quiz/start-super-trial/img/pause_7.jpg',
    ...
    },
    {
        type: 'interstitial',
        title: 'Fear of loss',
        image: '/assets/quiz/start-super-trial/img/pause_8.jpg',
    ...
    },
    {
        ...
        image: '/assets/quiz/start-super-trial/img/pause_9.jpg',
    ...
    },
    {
        ...
        logoImages: [
            '/assets/quiz/start-super-trial/img/magazine_logo_1.jpeg',
            '/assets/quiz/start-super-trial/img/magazine_logo_2.jpeg',
            '/assets/quiz/start-super-trial/img/magazine_logo_3.jpeg',
            '/assets/quiz/start-super-trial/img/magazine_logo_4.jpeg',
            '/assets/quiz/start-super-trial/img/magazine_logo_5.jpeg',
            '/assets/quiz/start-super-trial/img/magazine_logo_6.jpeg'
        ],
        logosStyle: 'floating',
        buttonText: 'Continue'
    },
    ...
    },
    {
        ...
        logoImages: [
            '/assets/quiz/start-super-trial/img/univer_1.png',
            '/assets/quiz/start-super-trial/img/univer_2.png',
            '/assets/quiz/start-super-trial/img/univer_3.png'
        ],
        logosStyle: 'stack',
        buttonText: 'Continue'
    },
...
function renderAgeGate(item) {
    const ageImages = {
        '25_49': '/assets/quiz/start-super-trial/img/age-25-49.jpg',
        '50_59': '/assets/quiz/start-super-trial/img/age-50-59.jpg',
        '60_69': '/assets/quiz/start-super-trial/img/age-60-69.jpg',
        '70_plus': '/assets/quiz/start-super-trial/img/age-70+.jpg'
    };
...
function renderInterstitial(item) {
    ...
    if (item.layout === 'collage') {
        const collageImages = [
            '/assets/quiz/start-super-trial/img/screen3_img1.jpg',
            '/assets/quiz/start-super-trial/img/screen3_img2.jpg',
            '/assets/quiz/start-super-trial/img/screen3_img3.jpg',
            '/assets/quiz/start-super-trial/img/screen3_img4.jpg',
            '/assets/quiz/start-super-trial/img/screen3_img5.jpg',
            '/assets/quiz/start-super-trial/img/screen3_img6.jpg',
            '/assets/quiz/start-super-trial/img/screen3_img7.jpg',
            '/assets/quiz/start-super-trial/img/screen3_img8.jpg'
        ];
      ...
      <section class="screen-card interstitial-card interstitial-collage-card fade-in">
        ...
        <div class="collage-wrap" aria-hidden="true">
          ...
          <img class="collage-center" src="/assets/quiz/start-super-trial/img/screen3_centreimg.jpg" alt="Happy user">
    ...
    if (item.heading || item.body?.length) {
        host.innerHTML = `
      <section class="screen-card interstitial-card fade-in">
        <img class="interstitial-top-image" src="${item.image || '/assets/quiz/start-super-trial/img/age-50-59.jpg'}" alt="Pause and reflect illustration">
        ${item.heading ? `<h3 class="interstitial-heading">${item.heading}</h3>` : ''}
        ...
        <div class="comparison-grid">
          <div class="comparison-col comparison-col-before">
            ...
            <div class="comparison-visual">
              <img src="/assets/quiz/start-super-trial/img/before_quiz_final.jpg?v=1" alt="Before ForeverMe experience" class="comparison-image">
            </div>
          ...
          <div class="comparison-col comparison-col-highlight">
            ...
            <div class="comparison-visual">
              <img src="/assets/quiz/start-super-trial/img/after_quiz_final.jpg?v=1" alt="With ForeverMe experience" class="comparison-image">
            </div>
            <ul class="comparison-list">
